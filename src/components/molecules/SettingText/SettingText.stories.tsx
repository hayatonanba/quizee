    ...
    return (
      <div className='w-[500px]'>
        <div className='h-[80px] bg-gray-100 p-3'>
          <h1 className='font-bold'>表示名</h1>
          <label className="flex items-center border-black border-b py-1">
            <input type="text" className="w-full appearance-none border-none bg-transparent text-gray-700 focus:outline-none" placeholder='user_name' />
